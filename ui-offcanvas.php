...
<?php include 'partials/main.php'; ?>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Offcanvas')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'UI Elements' , 'title' => 'Offcanvas')); ?>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Use the buttons below to show and hide an offcanvas element via
