...
<?php include 'partials/main.php'; ?>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Dropdowns')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'UI Elements' , 'title' => 'Dropdowns')); ?>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Any single <code>.btn</code> can be turned into a dropdown
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                Dropdown Menu Dark <i class="mdi mdi-chevron-down"></i>
                                            </button>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex gap-3 flex-wrap">
                                            ...
                                            <div class="btn-group">
                                                <button class="btn btn-warning dropdown-toggle" type="button" id="dropdownMenuClickableOutside" data-bs-toggle="dropdown" data-bs-auto-close="inside" aria-expanded="false">
