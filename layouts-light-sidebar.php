...
<?php include 'partials/main.php'; ?>
    ...
    <?php includeFileWithVariables('partials/title-meta.php', array('title' => 'Light Sidebar')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php includeFileWithVariables('partials/page-title.php', array('pagetitle' => 'Vertical' , 'title' => 'Light Sidebar')); ?>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div>
                                                    ...
                                                    <button type="button" class="btn btn-subtle-secondary btn-sm active">
                                                        1Y
                                                    </button>
                                                </div>
                                            </div>
